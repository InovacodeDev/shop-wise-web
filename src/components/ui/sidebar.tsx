...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
    ...
    return (
        <div
            ...
            data-sidebar="header"
            className={cn(
                "flex h-16 shrink-0 items-center gap-2 p-3",
                state === "collapsed" && "justify-center px-2 py-3",
                className
            )}
            {...props}
        />
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
    ...
    return (
        <div
            ref={ref}
            data-sidebar="footer"
            className={cn("flex flex-col gap-2 p-3 mt-auto", state === "collapsed" && "p-2", className)}
            {...props}
        />
    );
});
...
>(({ className, asChild, ...props }, ref) => {
    ...
    return <Comp ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative", className)} {...props} />;
});
